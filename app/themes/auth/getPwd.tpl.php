    ...
    <div class="mainbox">
        ...
        <div class="mill loginbox fl">
            <form id="login_form" method="post">
                <h3>找回密码</h3>
                <div class="from_cont">
                    <p><input type="text" name="username"  placeholder="请输入手机号或账号"/><b></b></p>
                    <p><input type="text" name="email"  placeholder="请输入邮箱" /><b></b></p>
                </div>
                <p class="tip_most"><span>想起密码？<a href="<?=$logUrl?>">去登陆</a></span></p>
                <p class="smit_btn"><input type="submit" value="立即找回" /></p>
                <input type="hidden" name="_token"  value="<?=_token();?>"/>
            </form>
        </div>
        <a class="back_link" href="<?=$logUrl?>">返回登陆</a>
        <p class="clear"></p>
    </div>
    ...
    <script>
        $(document).ready(function () {
            $('#login_form').validate({
                ...
                messages: {
                    username: {
                        required: '<i class="fa fa-exclamation-circle"></i>请输入手机号或账号'
                    },
                    email:{
