...
<div class="main_content">
    ...
    <fieldset class="layui-elem-field">
        <legend>二、套餐：12000元，推荐两个提车，三层满给1万，四层见点5000</legend>
        <div class="layui-field-box">
            <form method="post">
    ...
    <fieldset class="layui-elem-field">
        <legend>五、套餐、36000 推荐1个提车，推荐2个给1万，三层满给1万或2万或3万，四层满见点5000</legend>
        <div class="layui-field-box">
            <form method="post">
                <input type="hidden" name="typeid" value="type5">
                <table class="table_from">
                    <tr><td>套餐金额：</td><td><input type="text" name="money" value="36000"/>元</td></tr>
                    <tr><td>提车支出：</td><td><input type="text" name="car_money" value=""/>元</td></tr>
