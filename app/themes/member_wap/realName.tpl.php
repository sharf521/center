...
if ($userInfo->card_status == 2) : ?>
    ...
    <table class="table_from">
        ...
        <tr>
            <td>性别：</td>
            <td><?= $sex_array[$userInfo->sex] ?></td>
        </tr>
        <tr>
            <td>身份证号：</td>
            <td><?= $userInfo->card_no ?></td>
        </tr>
        <tr>
            <td>籍贯：</td>
            <td><?= $region->getName($userInfo->province) ?> <?= $region->getName($userInfo->city) ?> <?= $region->getName($userInfo->county) ?></td>
        </tr>
        <tr>
            <td align="right">身份证正面：</td>
            <td><a href="<?= $userInfo->card_pic1 ?>" target="_blank"><img src="<?= $userInfo->card_pic1 ?>"
        ...
        <tr>
            ...
            <td>
                <a href="<?= $userInfo->card_pic2 ?>" target="_blank"><img src="<?= $userInfo->card_pic2 ?>"
                                                                           align="absmiddle" width="100"/></a>
...
<?php else : ?>
    ...
    <form method="post">
        <table class="table_from">
            ...
            <? } ?>
            <tr>
                <td colspan="2"><input type="submit" class="submit" value="保 存"/></td>
            </tr>
        </table>
    </form>
    <script>
